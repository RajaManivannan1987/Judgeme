 ...
 */
public class GenresAdapter1 extends BaseAdapter {
    ...
    public GenresAdapter1(Context context, ArrayList<MyGenres> mobileValues, String clipID) {
        this.context = context;
        this.list = mobileValues;
        this.clipIid = clipID;
    }

    public GenresAdapter1(Context context, ArrayList<GenresSetting> GenerList, boolean flag) {
        this.context = context;
